...
class Spirit_Of_Football_Press_Resource_CPT {
	 ...
	 * @var string
	 */
	public $taxonomy_rest_base = 'press-resource-type';
	 ...
	 * @var string
	 */
	public $taxonomy_free_name = 'press-resource-tag';
	 ...
	 * @var string
	 */
	public $taxonomy_free_rest_base = 'press-resource-tag';
	...
	/**
	 * Creates a free-tagging Taxonomy.
	 *
	 * @since 1.0.0
	 */
	public function taxonomy_free_create() {
		...
		$args = [
			...
			'labels'            => [
				...
				'popular_items'              => __( 'Popular Press Resource Tags', 'sof-press' ),
				'separate_items_with_commas' => __( 'Separate Press Resource Tags with commas', 'sof-press' ),
				'add_or_remove_items'        => __( 'Add or remove Press Resource Tag', 'sof-press' ),
				'choose_from_most_used'      => __( 'Choose from the most popular Press Resource Tags', 'sof-press' ),
			],
